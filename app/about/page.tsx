...
export const metadata: Metadata = {
  title: 'About PakBizBranches | Pakistan\'s Trusted Free Business Directory',
  description: 'Learn about PakBizBranches — Pakistan\'s leading free business directory. Our mission is to connect 15,000+ verified local businesses with customers across 150+ cities. No registration required.',
...
const values = [
  ...
  },
  {
    Icon: Users,
    title: 'Who We Serve',
    desc: 'We serve small businesses, enterprises, and entrepreneurs across all 150+ cities of Pakistan — helping them get discovered online for free.',
    color: '#10b981',
  },
  {
    Icon: Globe,
    title: 'Our Reach',
    desc: 'With 15,000+ verified listings and growing monthly visitors, PakBizBranches is one of Pakistan\'s most trusted free business directories.',
    color: '#f59e0b',
  },
  {
    Icon: Award,
        ...
        <section className="py-16 bg-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-4">
              ...
              <p>
                Today, with <strong>15,000+ verified business listings</strong> across <strong>150+ cities</strong> and thousands of daily visitors, we&apos;re proud to be one of Pakistan&apos;s most trusted free business directories. And we&apos;re just getting started.
              </p>
            </div>
          </div>
        </section>
